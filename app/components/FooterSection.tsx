...
export function FooterSection() {
  return (
    <footer id="contact" className="px-6 pb-24 pt-20 sm:px-8 lg:px-12">
      <div className="mx-auto max-w-[1440px] space-y-10">
        <ScrollReveal className="glass-panel rounded-[32px] border border-white/10 bg-surface-container/80 p-8 shadow-[0_40px_120px_rgba(0,112,255,0.14)] sm:p-12">
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            ...
            <div className="space-y-4 rounded-[24px] border border-white/5 bg-surface-container-high/80 p-6">
              ...
              <div className="space-y-3">
                <p className="text-sm text-white">hello@marvellous.tech</p>
              ...
              <a
                href="mailto:hello@marvellous.tech"
        ...
        <div className="flex flex-col gap-4 border-t border-white/10 pt-6 text-sm text-on-surface-variant sm:flex-row sm:justify-between">
          <p>
            © 2026 Marvellous Tech Portfolio. Designed for precision, speed, and
            elevated systems.
          </p>
          <p>Built with modern web architecture and motion-first polish.</p>
        </div>
      </div>
    </footer>
  );
